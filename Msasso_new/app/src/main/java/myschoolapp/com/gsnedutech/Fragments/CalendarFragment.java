...
import myschoolapp.com.gsnedutech.CalendarEventDisplay;
...
//    ImageView nextMonth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewCalendar = inflater.inflate(R.layout.fragment_calendar, container, false);
        unbinder = ButterKnife.bind(this, viewCalendar);
...
//        });
        ...
        public void onDayClick(Date dateClicked) {
            selectedDate = new SimpleDateFormat("dd MMM yyyy").format(dateClicked);
        ...
        public void onMonthScroll(Date firstDayOfNewMonth) {
            ...
            selectedDate = new SimpleDateFormat("dd MMM yyyy").format(firstDayOfNewMonth);
...
class AdapterEvents extends RecyclerView.Adapter<AdapterEvents.ViewHolder> {
    ...
    public AdapterEvents.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mActivity).inflate(R.layout.item_cal_and_events, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterEvents.ViewHolder holder, int position) {
        ...
        for (int i=0;i<eventList.size();i++){
            ...
            list.addAll(eventList.get(i).getEventDetails());
            for (int j=0;j<list.size();j++){
                if (list.get(j).getEventName().equalsIgnoreCase(text[0])){
                    utils.showLog(TAG,"type "+eventList.get(i).getEventCategoryName());
                    type = eventList.get(i).getEventCategoryName();
                    if (eventList.get(i).getEventCategoryName().equalsIgnoreCase("Holidays")){
                        holder.llMain.setBackgroundResource(R.drawable.bg_orange_grad_cal);
                    }else {
                        holder.llMain.setBackgroundResource(R.drawable.bg_blue_grad_cal);
                    }
            ...
            public void onClick(View view) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        Toast.makeText(mActivity,"You Clicked : " + menuItem.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
                popup.show();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(mActivity, CalendarEventDisplay.class);
    ...
    void getEvents(String month,String year){
        ...
        try {
            ...
            if (sh_Pref.getBoolean("teacher_loggedin", false) || sh_Pref.getBoolean("admin_loggedin", false)) {
