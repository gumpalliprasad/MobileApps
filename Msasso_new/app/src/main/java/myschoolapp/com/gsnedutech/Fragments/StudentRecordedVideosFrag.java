...
public class StudentRecordedVideosFrag extends Fragment {
    ...
    public StudentRecordedVideosFrag() {
...
//                                tvRecordedCount.setText(videoSessionrecordingObjList.size() + " Videos");
    ...
    class SessionAdapter extends RecyclerView.Adapter<SessionAdapter.ViewHolder> {
        ...
        public SessionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new SessionAdapter.ViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.item_recorded_session, parent, false));
        }
