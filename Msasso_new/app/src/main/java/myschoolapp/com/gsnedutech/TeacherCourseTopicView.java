...
public class TeacherCourseTopicView extends AppCompatActivity implements NetworkConnectivity.ConnectivityReceiverListener {

    private static final String TAG = TeacherCourseTopicView.class.getName();
...
//        isNetworkAvail = false;
    ...
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (!isConnected) {
            isNetworkAvail = false;
            utils.alertDialog(1, TeacherCourseTopicView.this, getString(R.string.error_connect), getString(R.string.error_internet),
    ...
    private void init() {
        ...
        SubChapterTopic mTopic = listTopics.get(0);
        ...
        rvTopicItems.setLayoutManager(new LinearLayoutManager(TeacherCourseTopicView.this));
    ...
    private void getReports() {
        ...
        utils.showLoader(TeacherCourseTopicView.this);
                ...
                if (response.body() != null) {
                    try {
                        ...
                        if (parentjObject.getString("StatusCode").equalsIgnoreCase("200")) {
                            ...
                            runOnUiThread(() -> {
                                utils.dismissDialog();
                                MyUtils.forceLogoutUser(toEdit, TeacherCourseTopicView.this, message, sh_Pref);
                            });
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
    ...
    class TopicItemsAdapter extends RecyclerView.Adapter<TopicItemsAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(TeacherCourseTopicView.this).inflate(R.layout.item_topic_options, parent, false));
        }
            ...
            switch (customTopic.getName()) {
                case "Concept Based Learning":
                    ...
                    holder.itemView.setOnClickListener(view -> {
                        Intent i = new Intent(TeacherCourseTopicView.this, TopicVideoActivity.class);
                ...
                case "Question and Answers":
                    ...
                    holder.itemView.setOnClickListener(view -> {
                        Intent intent = new Intent(TeacherCourseTopicView.this, QAActivity.class);
                ...
                case "Summary":
                    ...
                    holder.itemView.setOnClickListener(view -> {
                        Intent intent = new Intent(TeacherCourseTopicView.this, SummaryActivity.class);
                ...
                case "Worksheet Practice":
                    ...
                    holder.tvCount.setText(customTopic.getTopicCount() + "");
                    holder.itemView.setOnClickListener(view -> {
                        Intent testdefault_intent = new Intent(TeacherCourseTopicView.this, CoursePracticeTest.class);
                ...
                case "Synopsis":
                    ...
                    holder.tvCount.setVisibility(View.GONE);
                    holder.itemView.setOnClickListener(view -> {
                        Intent intent = new Intent(TeacherCourseTopicView.this, TextBookActivity.class);
                ...
                case "Mock Test":
                    ...
                    holder.itemView.setOnClickListener(view -> {
                        Intent testmock_intent = new Intent(TeacherCourseTopicView.this, TopicMockTestInfo.class);
                ...
                case "Topic Resources":
                    ...
                    holder.itemView.setOnClickListener(v -> {
                        Intent intent = new Intent(TeacherCourseTopicView.this, ResourcesListActivity.class);
