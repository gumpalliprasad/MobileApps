...
public class OTStudentOnlineTestActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private static final String TAG = OTStudentOnlineTestActivity.class.getName();
    ...
    String testId, correctMarks, wrongMarks, testCategory;
    String appVersion = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NetworkConnectivity.isConnected(OTStudentOnlineTestActivity.this)) {
            updatedDevice();
            getOnlineTestQuePaper(getIntent().getStringExtra("testFilePath"));
        } else {
            new MyUtils().alertDialog(1, OTStudentOnlineTestActivity.this, getString(R.string.error_connect), getString(R.string.error_internet),
...
//                    Log.v(TAG, "que time new " + arrayOfArrays.get(subSpinner.getSelectedItemPosition()).get(quesNo).getTimeTaken());
        ...
        tvPshow.setOnClickListener(v -> {
            Dialog dialog = new Dialog(OTStudentOnlineTestActivity.this);
        ...
        etItq.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (length > 0 && !Pattern.matches("^-?[0-9]{0,4}(\\.\\d{0,2}+)?$", text)) {
                    ...
                    Toast.makeText(OTStudentOnlineTestActivity.this, "You can enter 4 digit before decimal and 2 digit after decimal. (eg:- 9999.99)", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    class InstructionAdapter extends RecyclerView.Adapter<InstructionAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(OTStudentOnlineTestActivity.this).inflate(R.layout.item_instructions, parent, false));
        }
    ...
    private void init() {
                ...
                if (listSectionDetails.get(0).getTemplateSection() != null && listSectionDetails.get(0).getTemplateSection().size() > 0) {
                    ...
                    findViewById(R.id.tv_instructions).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            rvInstructions.setLayoutManager(new LinearLayoutManager(OTStudentOnlineTestActivity.this));
        ...
        correctMarks = String.valueOf(getIntent().getIntExtra("correctMarks", 0));
...
//            TODO : sort the array with examquestion number
        ...
        timer.schedule(hourlyTask, 0l, 1000 * config.dbSync);

        /* Creating adapter for spinner */
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(OTStudentOnlineTestActivity.this, R.layout.spinner_test_item, subList);
        ...
        subSpinner.setOnItemSelectedListener(OTStudentOnlineTestActivity.this);
    ...
    private void slideUpDown() {
        ...
        if (!isPanelShown()) {
            ...
            RecyclerView.Adapter adapter = new OnlineTestQueListAdapter(OTStudentOnlineTestActivity.this, arrayOfArrays.get(subSpinner.getSelectedItemPosition()));
...
//            Log.v(TAG, "allquelist size - " + testQueList.get(i).getSelectedAnswer());
    ...
    private void PrepareResult(Boolean testFinal) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            if (new File(getExternalFilesDir(null) + "/.rankrPlus/onlinetest.json").exists()) {
                new File(getExternalFilesDir(null) + "/.rankrPlus/onlinetest.json").delete();
            } else {
            ...
            try {
                ...
                Writer output = null;
                File file = new File(getExternalFilesDir(null) + "/.rankrPlus/onlinetest.json");
            ...
            postFile = new File(getExternalFilesDir(null) + "/.rankrPlus/onlinetest.json");
        ...
        if (testFinal) {
            if (NetworkConnectivity.isConnected(this)) {
                ...
                new AlertDialog.Builder(OTStudentOnlineTestActivity.this)
...
//                    Log.v(TAG, "sectionName - " + listSectionDetails.get(x).getSectionName());
            ...
            values.put("chapterCCMapId", question.getChapterCCMapId());
            values.put("topicCCMapId", question.getTopicCCMapId());
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    void getOnlineTestQuePaper(String... strings) {
        utils.showLoader(OTStudentOnlineTestActivity.this);
    ...
    void getDBTestQuestions() {
        ProgressDialog loading = new ProgressDialog(OTStudentOnlineTestActivity.this);
                ...
                if (response.body() != null) {
                    try {
                        ...
                        if (ParentjObject.getString("status").equalsIgnoreCase("200")) {
                            ...
                            Intent intent = new Intent(OTStudentOnlineTestActivity.this, OTStudentTestOnlineCompleted.class);
