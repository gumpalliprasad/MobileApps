...
public class StudentAttendance extends AppCompatActivity implements NetworkConnectivity.ConnectivityReceiverListener {
    ...
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (!isConnected) {
            ...
            utils.alertDialog(1, StudentAttendance.this, getString(R.string.error_connect), getString(R.string.error_internet),
    ...
    private void init() {
        ...
        rvMonthOptions.setLayoutManager(new LinearLayoutManager(StudentAttendance.this));
        ...
        findViewById(R.id.tv_leave_req).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentAttendance.this,StudentLeaveRequest.class);
...
//                                    tvTotalPercent.setText(percent+"%");
                                    ...
                                    if (totalPercentage.isNaN()) tvTotalPercent.setText("0 %");
                                    else {
                                        String s = String.format("%.2f", totalPercentage);
                                        tvTotalPercent.setText("" + s + " %");
                                    }
                                    getAttendanceAnalysis();
                                }catch (Exception e){
                                    getAttendanceAnalysis();
                            ...
                            runOnUiThread(() -> {
                                utils.dismissAlertDialog();
                                MyUtils.forceLogoutUser(toEdit, StudentAttendance.this, message, sh_Pref);
                            });
                        }else{
                            getAttendanceAnalysis();
                        }
                    ...
                    try {
                        ...
                        if (ParentjObject.getString("StatusCode").equalsIgnoreCase("200")) {
                           ...
                           runOnUiThread(new Runnable() {
                               ...
                               public void run() {
//                                   setUpChart();
                                   rvChart.setLayoutManager(new LinearLayoutManager(StudentAttendance.this,RecyclerView.HORIZONTAL,false));
...
//                                   findViewById(R.id.ll_chart).setVisibility(View.VISIBLE);
    ...
    class ChartAdapter extends RecyclerView.Adapter<ChartAdapter.ViewHolder>{
        ...
        public ChartAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(StudentAttendance.this).inflate(R.layout.item_attend_chart,parent,false));
        }
    ...
    class OptionAdapter extends RecyclerView.Adapter<OptionAdapter.ViewHolder>{
        ...
        public OptionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(StudentAttendance.this).inflate(R.layout.item_month_att,parent,false));
        }
