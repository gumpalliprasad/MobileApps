...
import myschoolapp.com.gsnedutech.Fragments.StudentOTLiveExamsFrag;
import myschoolapp.com.gsnedutech.Fragments.StudentOTPreviousExamsFrag;
import myschoolapp.com.gsnedutech.Util.MonthYearPickerDialog;
import myschoolapp.com.gsnedutech.Util.MyUtils;
import myschoolapp.com.gsnedutech.Util.NetworkConnectivity;

public class StudentLiveExamsTabs extends AppCompatActivity implements NetworkConnectivity.ConnectivityReceiverListener {

    private static final String TAG = StudentLiveExamsTabs.class.getName();
...
//                        getHomeWorks();
    ...
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (!isConnected) {
            ...
            utils.alertDialog(1, StudentLiveExamsTabs.this, getString(R.string.error_connect), getString(R.string.error_internet),
    ...
    void init(){
        ...
        adapter.addFragment(new StudentOTPreviousExamsFrag(),"Previous Exams");
