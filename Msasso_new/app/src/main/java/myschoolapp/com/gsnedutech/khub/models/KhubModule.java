...
public class KhubModule implements Serializable {
    ...
    @SerializedName("tags")
    @Expose
    private List<KhubTagObj> tags = null;
    ...
    public List<KhubTagObj> getTags() {
        return tags;
    }

    public void setTags(List<KhubTagObj> tags) {
        this.tags = tags;
    }
